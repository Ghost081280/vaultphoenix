                ...
                <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(250px, 1fr)); gap: 15px;">
                    ...
                    <div class="form-group" style="margin-bottom: 0;">
                        ...
                        <select class="form-input" id="budgetFilter">
                            ...
                            <option value="low">$300 - $500/location</option>
                            <option value="medium">$500 - $700/location</option>
                            <option value="high">$700+/location</option>
                        </select>
                    </div>
                </div>
            </div>
                            ...
                            <div class="card">
                                ...
                                <div style="padding: 15px; background: rgba(34,197,94,0.1); border: 1px solid rgba(34,197,94,0.3); border-radius: 8px; margin-bottom: 15px;">
                                    ...
                                    <div style="font-size: 0.8rem; color: rgba(255,255,255,0.7); padding-top: 10px; border-top: 1px solid rgba(255,255,255,0.1); margin-top: 10px;">
                                        📱 Includes: Scanner Web App • Advertisement Display • Token Recovery • Analytics • All Features
                                    </div>
                                </div>
